...
public class CompressedPhonemeKeys : IAnimationValueInterface
{
    public byte[] Buffer { get; set; } = [];

    public CompressedTimeKeys CompressedTimeKeys { get; set; }

    public class Serializer : MetaSerializer<CompressedPhonemeKeys>
    {
        public override void PreSerialize(ref CompressedPhonemeKeys? obj, MetaStream stream,
            MetaClassType? type = null) =>
            obj ??= new CompressedPhonemeKeys();

        public override void Serialize(ref CompressedPhonemeKeys obj, MetaStream stream, MetaClassType? type = null)
        {
